# ui5-typescript-hello-world / A Small TypeScript UI5 Example App
...
This app demonstrates a TypeScript setup for developing UI5 applications (given from SAP), <b> with small additions by me (@Mischa1610 - Michael Alekseew) like prettier, lint-stage, husky, ... and also added here the custom-control example.</b>
...
During the commit the changed files will be checked with eslint and prettier with the help of [husky](https://typicode.github.io/husky) and [lint-staged](https://github.com/okonet/lint-staged#configuration).
...
Do the following to format all files with prettier:

```sh
npm run format
```

Do the following to check all files with prettier:
